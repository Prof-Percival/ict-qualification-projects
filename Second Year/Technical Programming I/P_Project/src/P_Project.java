import java.util.*; //The package name was incorrect on the import statement. It was java.utility instead of java.util 
...
public class P_Project
{
 ...
 {
        int num1, num2; double result; //There was a semi-colon between the two variables (num2 and result) There was suppose to be a comma (,) not a semi-colon(;) 
      ...
      result = (num1 * 2) % num2 - num1; //a non-existing (non-declared) variable was used (nums1 instead of num1)
